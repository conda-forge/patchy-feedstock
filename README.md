...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/patchy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14220&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/patchy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `patchy` can be installed with:

```
conda install patchy
```

It is possible to list all of the versions of `patchy` available on your platform with:
